...
const SvgAlignCenterSolid = props => (
  <svg
    aria-hidden="true"
    data-prefix="fas"
    data-icon="align-center"
    className="align-center-solid_svg__svg-inline--fa align-center-solid_svg__fa-align-center align-center-solid_svg__fa-w-14"
    viewBox="0 0 448 512"
    {...props}
  >
    <path
