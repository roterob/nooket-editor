...
const SvgStrikethroughSolid = props => (
  <svg
    aria-hidden="true"
    data-prefix="fas"
    data-icon="strikethrough"
    className="strikethrough-solid_svg__svg-inline--fa strikethrough-solid_svg__fa-strikethrough strikethrough-solid_svg__fa-w-16"
    viewBox="0 0 512 512"
    {...props}
  >
    <path
