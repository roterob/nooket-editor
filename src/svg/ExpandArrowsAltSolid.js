...
const SvgExpandArrowsAltSolid = props => (
  <svg
    aria-hidden="true"
    data-prefix="fas"
    data-icon="expand-arrows-alt"
    className="expand-arrows-alt-solid_svg__svg-inline--fa expand-arrows-alt-solid_svg__fa-expand-arrows-alt expand-arrows-alt-solid_svg__fa-w-14"
    viewBox="0 0 448 512"
    {...props}
  >
    <path
